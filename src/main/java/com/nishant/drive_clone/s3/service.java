...
public class service {
	...
	public String createPresignedUrlForUpload(String bucketName, String keyName, String contentType,
	...
	public String createPresignedUrlForDownload(String bucketName, String keyName) {
		try (S3Presigner presigner = S3Presigner.create()) {
